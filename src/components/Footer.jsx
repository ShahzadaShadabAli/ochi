...
function Footer() {
  return (
    <footer className="w-full h-screen flex bg-white text-zinc-900 p-20">
      <div className="w-1/2 flex flex-col justify-between h-[105vh] pb-10 font-['founder'] leading-none text-[11vw] uppercase">
        <div className="heading">
          <h1 className="-mb-14">Eye-</h1>
          <h1 className="-mb-14">Opening</h1>
        </div>
        <svg
          width="72"
          height="30"
      ...
      <div className="w-1/2">
        <h1 className="text-[9vw] leading-none overflow-hidden font-['founder']">
          PRESENTATIONS
        </h1>
        ...
        <div className="w-75">
        <div className="">
          <h1 className="text-2xl my-7 font-['neue']">S:</h1>
          <div className="flex flex-col gap-1">
            {["instagram", "behance", "facebook", "linkedin"].map((d, i) => (
              <a
                key={i}
                className='font-["neue"] capitalize underline text-[1.3rem]'
                href=""
              >
                {d}
              </a>
        ...
        <div className="">
          <h1 className="text-2xl my-7 font-['neue']">L:</h1>
          <div className="flex flex-col gap-1">
            {["202-1965 W 4th Ave", "Vancouver, Canada", "30 Chukarina St", "Lviv, Ukraine"].map((d, i) => (
              <a
                key={i}
                className={`font-["neue"] capitalize underline text-[1.3rem] ${i == 2 ? "mt-8" : ""}`}
                href=""
              >
                {d}
              </a>
        ...
        <div className="">
          <h1 className="text-2xl my-7 font-['neue']">E:</h1>
          <div className="flex flex-col gap-1">
              <a
                className={`font-["neue"] capitalize underline text-[1.3rem]`}
                href=""
            ...
            <div className="w-25">
            <div className="">
          <h1 className="text-2xl my-7 font-['neue']">M:</h1>
          <div className="flex flex-col gap-1">
            {["Home", "Services", "Our Work", "About us", "Insights", "Contact us"].map((d, i) => (
              <a
                key={i}
                className={`font-["neue"] capitalize underline text-[1.3rem]`}
                href=""
